...
Welcome to the Cross-Platform Electron Kanban Dashboard project documentation. We utilize a fragmented documentation model to keep context sizes optimal, preventing context contamination while keeping domain specifications clean.
...
## 4. Codebase Map
- [Semantic Symbol Map](file:///Users/macbook/Desktop/project-progress-board/docs/map.md): Map of key classes, interfaces, and types with their descriptions.
